            ...
            <div className="max-w-7xl mx-auto px-8">
                <div className="bg-slate-800 rounded-lg shadow-lg overflow-hidden mb-16">
                    <div className="p-12 text-center">
                        <p className="text-sm text-fuchsia-400 font-semibold">{t('build.forDevelopers')}</p>
                        <h2 className="text-4xl font-extrabold text-white mt-4">{t('build.title')}</h2>
                ...
                <SectionTitle
                    titleKey="build.ecosystemTitle"
                    subTitleKey="build.ecosystemDescription"
                    t={t}
                />
                ...
                <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="bg-slate-800 rounded-lg shadow-lg overflow-hidden">
                        <div className="p-6">
                            <h3 className="text-xl font-bold text-white">{t('build.aiStudio')}</h3>
                            <p className="text-slate-400 mt-2">{t('build.aiStudioDescription')}</p>
                        </div>
                    ...
                    <div className="bg-slate-800 rounded-lg shadow-lg overflow-hidden">
                        <div className="p-6">
                            <h3 className="text-xl font-bold text-white">{t('build.geminiApi')}</h3>
                            <p className="text-slate-400 mt-2">{t('build.geminiApiDescription')}</p>
                        </div>
                        <div className="p-6 bg-slate-700/50 flex justify-between items-center">
                            <a href="#" className="text-fuchsia-400 hover:underline">{t('cta.learnMore')}</a>
                            <ArrowRight className="w-6 h-6 text-fuchsia-400" />
