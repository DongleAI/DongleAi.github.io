...
export default function AiSafety({ titleKey, subTitleKey, SectionTitle, t }) {
    return (
        <div className="max-w-7xl mx-auto px-6 text-center">
            <SectionTitle titleKey={titleKey} subTitleKey={subTitleKey} t={t} />
            ...
            >
                <h3 className="text-3xl font-bold text-white mb-4">{t('safety.transparencyTitle')}</h3>
                <p className="text-slate-400 leading-relaxed mb-8">{t('safety.description')}</p>
