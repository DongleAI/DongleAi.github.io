...
export default function AiAbyss({ getIconComponent, ns }) {
    const { t } = useTranslation([ns, "translation"]);
    
    const productName = t("aiabyss:productName");
    const hero = {
        title: t("aiabyss:hero.title"),
        tagline: t("aiabyss:hero.tagline"),
        subtext: t("aiabyss:hero.subtext"),
    };
    const showcaseData = [
        { type: 'image', src: 'https://via.placeholder.com/600x400?text=Abyss+Image+1', prompt: t("aiabyss:showcase.prompt1") },
        { type: 'image', src: 'https://via.placeholder.com/600x400?text=Abyss+Image+2', prompt: t("aiabyss:showcase.prompt2") },
        { type: 'image', src: 'https://via.placeholder.com/600x400?text=Abyss+Image+3', prompt: t("aiabyss:showcase.prompt3") },
    ];
    const performanceTable = [
        {
            metric: t("aiabyss:performance.quality"),
            value: "90",
            competitorA: "85",
            competitorB: "80",
            previousValue: "75",
