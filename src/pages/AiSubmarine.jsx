...
export default function AiSubmarine({ getIconComponent, ns }) {
    const { t } = useTranslation([ns, "translation"]);

    const productName = t("aisubmarine:productName");
    const hero = {
        title: t("aisubmarine:hero.title"),
        tagline: t("aisubmarine:hero.tagline"),
        subtext: t("aisubmarine:hero.subtext"),
    };
    const showcaseData = [
        { type: 'video', src: 'https://www.w3schools.com/html/mov_bbb.mp4', prompt: t("aisubmarine:showcase.prompt1") },
        { type: 'video', src: 'https://www.w3schools.com/html/movie.mp4', prompt: t("aisubmarine:showcase.prompt2") },
    ];
    const performanceTable = [
        {
            metric: t("aisubmarine:performance.resolution"),
            value: "1080p",
            competitorA: "720p",
            competitorB: "480p",
            previousValue: "360p",
